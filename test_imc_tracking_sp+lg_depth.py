...
def parse_args():
    ...
    parser.add_argument('--min_corr_0N', type=int, default=5,
                        help='Minimum correspondences to attempt 0->N pose estimation')
    parser.add_argument('--min_inliers_0N', type=int, default=0,
    ...
    parser.add_argument('--save_json', type=Path, default=default_root / 'results_imc_eval_splg.json',
                        help='Full results (per_bag + summary)')
    # Global summary だけを吐く JSON
    parser.add_argument('--save_summary_json', type=Path,
                        default=default_root / 'results_imc_eval_summary_splg.json',
