...
def parse_args():
    ...
    parser.add_argument('--dataset_root', type=Path, default=Path('data/megadepth'),
    ...
    parser.add_argument('--save_json', type=Path, default=Path('outputs/fig6_megadepth_tracking.json'),
