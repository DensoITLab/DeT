...
def parse_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default="official", help="path to the checkpoint")
    parser.add_argument("--dump_dir", type=str, default=None, help="directory for dumped matching results")
    parser.add_argument("--profiler_name", type=str, default=None, help="options: [inference, pytorch], or leave unset")
    parser.add_argument("--batch_size", type=int, default=1, help="batch size per GPU")
    parser.add_argument("--num_workers", type=int, default=2)
    parser.add_argument("--thr", type=float, default=None, help="override the coarse-level matching threshold")
...
if __name__ == "__main__":
    ...
    loguru_logger.info("Start evaluation.")
