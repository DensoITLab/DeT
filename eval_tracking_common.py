...
def add_common_tracking_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--nn_link_radius", type=float, default=5.0 * np.sqrt(2.0))
    parser.add_argument("--det_search_radius", type=float, default=832.0 * np.sqrt(2.0))
